...
exports.FlightService = exports.BadRequestError = exports.ConflictError = void 0;
...
class FlightService {
    ...
    async scheduleFlight(data) {
        ...
        if (!aircraft) {
            throw new aircraft_service_1.RecordNotFoundError(`Aircraft with id '${data.aircraftId}' not found`);
        }
        ...
        const aircraftConflict = await this.prisma.flightSession.findFirst({
            where: {
                ...
                status: { in: [client_1.FlightStatus.SCHEDULED, client_1.FlightStatus.IN_PROGRESS] },
                AND: [
        ...
        return this.prisma.flightSession.create({
            data: {
                ...
                status: client_1.FlightStatus.SCHEDULED,
            },
            include: {
                aircraft: true,
                pilot: {
